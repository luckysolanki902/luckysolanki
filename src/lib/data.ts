...
export const tools = {
  ...
  backend: [
    ...
    "Python, FastAPI",
    "REST APIs, JSON-RPC, Zod",
  ],
  ai: [
    "MCP Protocol, OpenAI Agents SDK",
    "AI tool surfaces, agent orchestration",
    "RAG, vector search, document-backed answers",
    "AI integrations, workflow automation",
  ],
  infrastructure: [
    "OAuth 2.1/PKCE, provider webhooks",
    "Queues, workers, schedulers, retries",
